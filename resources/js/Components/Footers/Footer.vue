...
<!--                        </button>-->
                        <button
                            ...
                            type="button"
                            onclick="window.open('https://www.linkedin.com/in/moynul-islam-shimanto-6350b8234', '_blank')"
                        >
                        ...
                        <button
                            ...
                            type="button"
                            onclick="window.open('https://github.com/mishimanto', '_blank')"
                        >
                ...
                Useful Links
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li>
                                    <a
                                        class="text-blueGray-600 hover:text-blueGray-800 font-semibold block pb-2 text-sm"
                                        href="https://github.com/mishimanto"
                                    >
                                        Github
                                    </a>
                                </li>
